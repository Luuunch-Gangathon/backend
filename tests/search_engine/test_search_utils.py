...
def test_name_to_slug():
    from app.api.search_engine.sources.search_utils import _name_to_slug
...
def test_generate_candidate_domains():
    from app.api.search_engine.sources.search_utils import _generate_candidate_domains
...
def test_get_supplier_domain_direct_hit():
    ...
    with patch(
        "app.api.search_engine.sources.search_utils._try_direct_domains",
...
def test_get_supplier_domain_falls_back_to_search():
    ...
    with patch(
        ...
        "app.api.search_engine.sources.search_utils._try_search_domain",
...
def test_try_search_domain_skips_blocklisted():
    ...
    from app.api.search_engine.sources.search_utils import _try_search_domain
    ...
    with patch(
        "app.api.search_engine.sources.search_utils.search",
        return_value=fake_results,
    ), patch(
        "app.api.search_engine.sources.search_utils._check_domain_exists",
    ) as mock_check, patch(
        "app.api.search_engine.sources.search_utils._verify_domain_with_llm",
        return_value=True,
    ), patch(
        "app.api.search_engine.sources.search_utils.asyncio",
    ) as mock_asyncio:
...
def test_find_product_page_tries_specific_first():
    ...
    with patch("app.api.search_engine.sources.search_utils.search", side_effect=mock_search):
